            ...
            (
                    ...
                    return(
                            <tr className="collection-item " key={index}>
                                ...
                                <td><Link to="/koszyk"><FontAwesomeIcon icon={faPlusCircle} onClick={()=>{this.handleAddQuantity(item.id)}}></FontAwesomeIcon></Link>
                                        <span>Ilość: {item.quantity}</span>
                                    <Link to="/koszyk"><FontAwesomeIcon icon={faMinusCircle} onClick={()=>{this.handleSubtractQuantity(item.id)}}></FontAwesomeIcon></Link>
                                </td>
                                <td>
             ...
             (
                 ...
                 <Link to="/home" className="backToHome">
                     <p>Wróć na </p><FontAwesomeIcon icon={faHome} /><p>stronę główną, aby kontynuwać zakupy</p>
                 </Link>
                 </div>
             )
       return(
