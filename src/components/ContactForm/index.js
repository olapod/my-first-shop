...
// 	<div><h2>Zostaw wiadomość, a skontaktujemy się z Tobą w ciągu 24h</h2>
// <Form onSubmit = { this.handleSubmit } >

// <FormGroup>
// <Label for='name'>Imię i nazwisko</Label>
// {this.state.nameValid.invalid &&
// <p className='input-error'>Pole nie może być puste!</p>}
// <Input
// 	type='text'
// 	name='name'
// 	required
...
// <p>Wiadomość została wysłana, niezwłocznie się z Tobą skontaktujemy</p>
// <Modal show={this.state.show} onHide={this.handleClose}>
// <Modal.Header closeButton>
